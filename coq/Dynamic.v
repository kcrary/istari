...
| canon_semifut        : canon (oper_semifut _)
...
Lemma value_semifut : forall {m1}, value (semifut m1).
Proof.
intros; apply value_i; eauto with dynamic.
Qed.
...
Lemma value_sequal : forall {m1 m2}, value (sequal m1 m2).
Proof.
intros; apply value_i; eauto with dynamic.
Qed.
...
Lemma value_coguard : forall {m1 m2}, value (coguard m1 m2).
Proof.
intros; apply value_i; eauto with dynamic.
Qed.
...
Lemma value_padmiss : forall {m1 m2}, value (padmiss m1 m2).
Proof.
intros; apply value_i; eauto with dynamic.
Qed.
...
Arguments value_semifut {object m1}.
...
Arguments value_coguard {object m1 m2}.
...
Arguments value_padmiss {object m1 m2}.
