...
Lemma subst_semifut :
  forall (s : @sub object) k, subst s (semifut k) = semifut (subst s k).
Proof.
prove_subst.
Qed.
...
Lemma subst_padmiss :
  forall (s : @sub object) m1 m2, subst s (padmiss m1 m2) = padmiss (subst s m1) (subst (under 1 s) m2).
Proof.
prove_subst.
Qed.
...
Hint Rewrite subst_univ subst_cty subst_con subst_karrow subst_tarrow subst_pi subst_clam subst_capp subst_ctlam subst_ctapp subst_lam subst_app subst_intersect subst_union subst_constfn subst_fut subst_semifut subst_cnext subst_cprev subst_next subst_prev subst_rec subst_equal subst_triv subst_eqtype subst_sequal subst_subtype subst_kind subst_all subst_alltp subst_exist subst_mu subst_ispositive subst_isnegative subst_voidtp subst_unittp subst_cunit subst_booltp subst_btrue subst_bfalse subst_bite subst_prod subst_sigma subst_cpair subst_cpi1 subst_cpi2 subst_ppair subst_ppi1 subst_ppi2 subst_set subst_iset subst_quotient subst_guard subst_coguard subst_wt subst_partial subst_halts subst_admiss subst_padmiss subst_uptype subst_seq subst_ext subst_extt subst_marker : subst.
