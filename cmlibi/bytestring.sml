...
(* The specification of string is leaked for the benefit of some SML implementations. *)
structure Bytestring :> BYTESTRING where type string = Word8Vector.vector =
   struct
      ...
      fun output outs str =
         OriginalBasis.BinIO.output (outs, str)
